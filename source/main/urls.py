...
from webapp.views import PollView, IndexView, PollCreateView, PollUpdateView, PollDeleteView, ChoiceCreateView, \
    ChoiceUpdateView, ChoiceDeleteView, AnswerCreateView
...
urlpatterns = [
    ...
    path('poll/<int:pk>/answer/create/', AnswerCreateView.as_view(), name='answer_create')
]
